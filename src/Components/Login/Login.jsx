          ...
          <div className="card flex-shrink-0 w-full md:w-3/4 lg:w-1/2 shadow-2xl bg-base-100">
            <form onSubmit={handleLogin} className="card-body">
              ...
              <div className="form-control mt-6">
                <button className="btn text-white hover:bg-[#48A5EE] bg-[#48A5EE]">Login</button>
              </div>
            </form>
            <p className="text-center font-medium text-lg text-[#00BFFF]">New Applicant ? <Link className="text-red-400" to="/register">Register</Link></p>
          </div>
        </div>
      </div>
    );
