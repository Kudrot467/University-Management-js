      ...
      <div className="card lg:card-side bg-base-100 shadow-xl" data-aos="fade-right">
        ...
        <div className="card-body w-full">
          ...
          <div className="card-actions justify-end">
            {
                user ? <Link to={`/course/${id}`}> <button className="btn hover:bg-[#48A5EE]">Get Started</button></Link> : <> <Link to='/register'><button className="btn hover:bg-[#48A5EE] mr-3">Purchase</button></Link> 
